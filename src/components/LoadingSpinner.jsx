...
const StyledWrapper = styled.div`
  /* Full-screen semi-transparent overlay for lazy loading */
  position: fixed;
  top: 0;
  left: 0;
  width: 100vw;
  ...
  backdrop-filter: blur(5px); /* Blurs the underlying content for a frosted glass effect */
  transition: opacity 0.3s ease; /* Smooth fade if controlled externally */
  ...
  .loader .text:nth-child(1) {
    ...
    font-size: calc(var(--main-size) / 6); /* Increased size for better visibility on large screen */
    margin-left: -2.1em;
    opacity: 0.6;
  }
  ...
  .loader .text:nth-child(3) {
    ...
    font-size: calc(var(--main-size) / 4);
    margin-left: -0.33em;
    opacity: 0.8;
  }
  ...
  .loader .text:nth-child(4) {
    ...
    font-size: calc(var(--main-size) / 3.5);
    margin-left: -0.05em;
    opacity: 0.9;
  }
  ...
  .loader .text:nth-child(9) {
    ...
    font-size: calc(var(--main-size) / 6);
    margin-left: 2.1em;
    opacity: 0.6;
  }
